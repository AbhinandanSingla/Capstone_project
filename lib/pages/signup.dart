  ...
  Widget _emailPasswordWidget() {
    return Column(
      children: <Widget>[
        ...
        _entryField(rollNoController,"Roll number"),
        _entryField(mailController,"Email id"),
        _entryField(pwdController,"Password", isPassword: true),
      ],
    );
  }
